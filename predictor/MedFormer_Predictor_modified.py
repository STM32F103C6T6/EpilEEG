...
class MedFormer_Predictor(BasePredictor):
    ...
    def _train_epoch(self, train_loader):
        """重写以适应 MedFormer 的 forward 接口，并与 BasePredictor.train() 的 3 个返回值保持一致。"""
        self.model.train()
        total_loss = 0
        all_preds = []
        all_labels = []
        ...
        for inputs, labels in train_loader:
            ...
            # MedFormer forward 只传递 inputs / x_enc
            ...
            # 保存预测结果，用于计算与 BasePredictor 一致的训练集 metrics
